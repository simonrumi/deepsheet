...
class RowHeaderDetail extends Component {
	...
	// componentDidUpdate() {
	//    if (this.props.sheet.rowMoved && this.props.sheet.rowMovedTo) {
	//       const moveArr = this.props.moveRow(
	//          this.props.sheet.rowMoved,
	//          this.props.sheet.rowMovedTo,
	//          this.props.sheet
	//       );
...
export default connect(
	mapStateToProps,
	{ toggledShowFilterModal } //moveRow
)(DragableRowHeader);
