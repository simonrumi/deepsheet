...
// TODO issue:
// clicking this icon
// 1. correctly triggers toggledShowFilterModal(true)
// 2. correctly gets to the point of sending out the action { type: TOGGLED_SHOW_FILTER_MODAL, payload: showModal };
// 3. incorrectly does not trigger the reducer filterModalReducer() ....why???
...
class IconFilter extends Component {
	render() {
		...
		return (
			<div className={allClasses} onClick={() => toggledShowFilterModal(true)} data-testid={this.props.testId}>
				<svg
