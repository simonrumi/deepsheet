...
export const updatedCell = cell => {
   ...
   if (isObject(cell.content)) {
      if (R.not(R.has('_id', cell.content)) || R.isNil(cell.content._id)) {
         console.log('WARNING: updateCell could not get sub-cell  content');
      } else {
         const contentText = fetchSummaryCellFromSheet(cell.content._id);
