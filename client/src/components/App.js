...
import { fetchedSheet, updateOneCell } from '../actions';
import {
   createCellReducers,
...
class App extends Component {
   async componentDidMount() {
      ...
      this.props.updateOneCell('updated one cell');
   }
   ...
   initializeCells() {
      ...
      if (
         ...
         const newCombinedReducer = createCellReducers(
            this.props.sheet.metadata
         );
         ...
         console.log(
            'Note: App.render.initializeCells had no data to operate on'
         );
      }
   }
