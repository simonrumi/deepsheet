...
class Cell extends Component {
	...
	renderBlankCell(cell) {
		return <div className={createClassNames(this.props.sheet, this.props.cellKey)} />;
	}

	// impure function
	renderRegularCell(cell) {
		// TODO take this if statement out of here and use renderBlankCell()
		if (this.props.blankCell) {
			return <div className={createClassNames(this.props.sheet, this.props.cellKey)} />;
		}
		return (
			<div
