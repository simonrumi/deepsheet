...
export const updatedHiddenColumns = hiddenColumns => {
	managedStore.store.dispatch({ type: UPDATED_COLUMN_VISIBILITY, payload: hiddenColumns });
};

export const updatedHiddenRows = hiddenRows => {
	managedStore.store.dispatch({ type: UPDATED_ROW_VISIBILITY, payload: hiddenRows });
};
