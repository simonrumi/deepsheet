...
export const REPLACED_CELLS_IN_RANGE = 'replaced_cells_in_range';
export const CLEAR_LIST_OF_CELLS_IN_RANGE = 'clear_list_of_cells_in_range';
export const UPDATED_RANGE_WAS_COPIED = 'updated_range_was_copied';
export const UPDATED_PASTING_CELL_RANGE = 'updated_pasting_cell_range';

// these are not actions, but the types to put into STARTED_ & COMPLETED_ UNDOABLE_ACTION
