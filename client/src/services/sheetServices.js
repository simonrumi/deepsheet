...
export const fetchSummaryCellFromSheet = maybeMemoize(async sheetId => {
	...
	console.log('fetchSummaryCellFromSheet got subSheet', subSheet);
	const summaryCellRow = subSheet.data.metatdata.summaryCell.row;
	const summaryCellColumn = subSheet.data.metatdata.summaryCell.column;
