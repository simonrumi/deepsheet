...
import { updateEditor, updatedCellBeingEdited } from '../actions';
import { indexToColumnLetter, indexToRowNumber, extractRowColFromString } from '../helpers';
...
export default connect(
	mapStateToProps,
	{ updateEditor, updatedCellBeingEdited }
)(Cell);
