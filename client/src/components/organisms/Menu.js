...
const Menu = props => {
   ...
   const renderHamburgerOrMenu = () => {
      if (showMenu) {
         ...
         const menuStyle = { maxHeight: '95vh' }; // a little less than the full size of the window to allow for the scrollbar at the bottom. Could/should make this a class in tailwind...but not high priority
