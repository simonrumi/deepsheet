...
import { updateEditor, setEditorRef, /*updatedCell*/ updatedCellBeingEdited } from '../actions';
...
class Editor extends Component {
	...
	handleChange(newValue) {
		...
		this.props.updatedCellBeingEdited({ ...newCellData, content: processedContent });
	}
}
